 ...
 * Text Domain:       woocommerce-quantity-style
 ...
 * This action is documented in includes/class-woocommerce-quantity-style-activator.php
 */
function activate_woocommerce_quantity_style() {
	require_once plugin_dir_path( __FILE__ ) . 'includes/class-woocommerce-quantity-style-activator.php';
	Woocommerce_Quantity_Style_Activator::activate();
}

/**
 * The code that runs during plugin deactivation.
 * This action is documented in includes/class-woocommerce-quantity-style-deactivator.php
 */
function deactivate_woocommerce_quantity_style() {
	require_once plugin_dir_path( __FILE__ ) . 'includes/class-woocommerce-quantity-style-deactivator.php';
 ...
 */
require plugin_dir_path( __FILE__ ) . 'includes/class-woocommerce-quantity-style.php';
